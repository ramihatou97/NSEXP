...
const features = [
  {
    ...
    description: 'Generate comprehensive neurosurgical chapters from multiple sources with advanced AI',
    icon: AutoAwesome,
    href: '/synthesis',
    color: 'primary',
  },
  {
    ...
    description: 'Search across textbooks, papers, and clinical guidelines with semantic understanding',
    icon: Search,
    href: '/search',
    color: 'secondary',
  },
  ...
  },
  {
    ...
    description: 'Visualize and navigate complex relationships between medical literature',
    icon: Science,
    href: '/citations',
    color: 'warning',
  },
